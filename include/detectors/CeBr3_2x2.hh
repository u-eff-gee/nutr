...
class CeBr3_2x2 : public Detector{
    public:
        CeBr3_2x2(const G4String name, const G4double theta, const G4double phi, const G4double dist_from_center, const vector<Filter> filters = {}, const vector<Filter> wraps = {}, G4double intrinsic_rotation_angle = 0.) : Detector (name, theta, phi, dist_from_center, filters, wraps, intrinsic_rotation_angle){};
