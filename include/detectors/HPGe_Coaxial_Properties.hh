...
struct HPGe_Coaxial_Properties {
  ...
  G4double detector_length; // Length of the detector crystal, including the
                            // rounded part
  G4double detector_face_radius; // Rounding radius of the crystal face
  G4double hole_radius; // Radius of the hole in the crystal which is penetrated
                        // by the cold finger
  G4double hole_depth;  // Depth of the hole, measured from the base of the
                        // crystal, including the rounded part
  G4double hole_face_radius; // Rounding radius of the tip of the hole. Most
  ...
  // the vacuum layer
  G4double end_cap_to_crystal_gap_front; // Distance from the front of the mount
  ...
  G4double end_cap_length; // Length of the end cap, including end cap window
                           // thickness
  G4double end_cap_outer_radius; // Outer radius of the end cap. Not used in the
                                 // actual construction, but can be used for
                                 // placements or calculation of the size of the
                                 // vacuum gap
  G4double end_cap_window_thickness; // Thickness of the window which faces the
                                     // target
  ...
  G4double cold_finger_radius; // Radius of the cold finger, which is equal to
                               // the rounding radius
  ...
  G4double dewar_wall_thickness; // Dewar wall thickness. Assumed to be the same
