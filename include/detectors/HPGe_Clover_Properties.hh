...
struct HPGe_Clover_Properties {
  ...
  // Detector crystals
  G4double crystal_radius; // Radius of the detector crystals if they were still
                           // round
  ...
  G4double crystal_gap; // The four crystals do not touch each other, but there
                        // is some gap in between
  G4double end_cap_to_crystal_gap_front; // Vacuum-filled gap between the end
  ...
  G4double end_cap_front_side_length; // Side length of the front end cap with a
  ...
  G4double end_cap_front_thickness; // Thickness of the end cap at the front
  ...
  G4double end_cap_back_side_length; // Side length of the back end cap with a
                                     // quadratic (see next variable) base area
