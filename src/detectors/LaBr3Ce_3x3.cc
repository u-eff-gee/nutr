...
void LaBr3Ce_3x3::Construct(G4LogicalVolume *world_logical, G4ThreeVector global_coordinates)
{
    ...
    G4Cons *circuit_housing_2_solid = new G4Cons("circuit_housing_2_solid", circuit_housing_2_rmax - circuit_housing_thickness, circuit_housing_2_rmax, circuit_housing_2_rmin - circuit_housing_thickness, circuit_housing_2_rmin, circuit_housing_2_length * 0.5, 0., twopi);
