...
Detector::Detector(const string _name, const double _theta, const double _phi,
                   ...
                   double _intrinsic_rotation_angle, double _dead_layer,
                   const double _default_filter_radius)
    : detector_name(_name), dead_layer(_dead_layer),
      default_filter_radius(_default_filter_radius), theta(_theta), phi(_phi),
