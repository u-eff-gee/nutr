...
void Target96Mo::Construct(const G4ThreeVector global_coordinates)
{
    ...
    auto mass_pe_disc = pi * radius_96mo * radius_96mo * thickness_pe * density_pe;
    ...
    auto area_pe_squarehole = side_pe * side_pe - pi * radius_pe_hole * radius_pe_hole;
    auto thickness_pe_squarehole = mass_pe_squarehole / density_pe / area_pe_squarehole;
    ...
    auto* target_pe_top_solid = new G4Tubs("target_pe_top_solid", 0., radius_pe_disc,
        0.5 * thickness_pe_disc, 0., 2. * pi);
    auto* target_pe_bottom_solid = new G4Tubs("target_pe_bottom_solid", 0., radius_pe_disc,
        0.5 * thickness_pe_disc, 0., 2. * pi);
    auto* target_pe_square_solid = new G4Box("target_pe_square", 0.5 * side_pe, 0.5 * side_pe,
    ...
    auto* target_pe_shell_solid = new G4Tubs("target_pe_shell", radius_96mo, radius_pe_hole,
        0.5 * thickness_96mo, 0., 2. * pi);
    ...
    new G4PVPlacement(
        0,
        global_coordinates + G4ThreeVector(0., 0., 0.5 * (thickness_96mo + thickness_pe_disc)),
