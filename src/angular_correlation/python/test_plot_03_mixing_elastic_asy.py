...
output_file_single_2d = Path('@PROJECT_BINARY_DIR@') / 'test_plot_03_mixing_elastic_asy_2d.pdf'
...
asy_45_exp=[0.1, 0.1, 0.1], asy_90_exp=[0.3, 0.1, 0.1], show_polarization=[True, False])

output_file_single_2d_exp = Path('@PROJECT_BINARY_DIR@') / 'test_plot_03_mixing_elastic_asy_2d_exp.pdf'
asy_plo.plot_single_2d(r'$\delta_1$', [r'$\delta_1$', r'$\delta_1$'], True, output_file_single_2d_exp)

output_file_single_3d = Path('@PROJECT_BINARY_DIR@') / 'test_plot_03_mixing_elastic_asy_3d.pdf'
