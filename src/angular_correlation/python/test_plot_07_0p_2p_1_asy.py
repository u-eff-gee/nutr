...
output_file_single_2d = Path('@PROJECT_BINARY_DIR@') / 'test_plot_07_0p_2p_1_asy_2d.pdf'
...
output_file_single_2d_exp = Path('@PROJECT_BINARY_DIR@') / 'test_plot_07_0p_2p_1_asy_2d_exp.pdf'
asy_plo.plot_single_2d(r'$\delta_2$', ['', r'$\delta_2$'], False, output_file_single_2d_exp, transition_label_rotation=0)

output_file_single_3d = Path('@PROJECT_BINARY_DIR@') / 'test_plot_07_0p_2p_1_asy_3d.pdf'
